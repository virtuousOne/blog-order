...
(function() {
  ...
  FT("formatting_link",
     "[link&formatting&formatting-link [][link foo][link&formatting&formatting-link ]]][string&formatting&formatting-link-string (][string http://lrm.com/][string&formatting&formatting-link-string )]");
  ...
  FT("formatting_linkReference",
     ...
     "[link&formatting&formatting-link [][link bar][link&formatting&formatting-link ]]:] [string http://lrm.com/]");

  FT("formatting_linkWeb",
     "[link&formatting&formatting-link <][link http://lrm.com/][link&formatting&formatting-link >]");

  FT("formatting_linkEmail",
     "[link&formatting&formatting-link <][link user@lrm.com][link&formatting&formatting-link >]");
  ...
  MT("linkTitle",
     "[link [[foo]]][string (http://lrm.com/ \"bar\")] hello");

  // Inline link without title
  MT("linkNoTitle",
     "[link [[foo]]][string (http://lrm.com/)] bar");

  // Inline link with image
  MT("linkImage",
     "[link [[][tag ![[foo]]][string (http://lrm.com/)][link ]]][string (http://lrm.com/)] bar");

  // Inline link with Em
  MT("linkEm",
     "[link [[][link&em *foo*][link ]]][string (http://lrm.com/)] bar");

  // Inline link with Strong
  MT("linkStrong",
     "[link [[][link&strong **foo**][link ]]][string (http://lrm.com/)] bar");

  // Inline link with EmStrong
  MT("linkEmStrong",
     "[link [[][link&strong **][link&em&strong *foo**][link&em *][link ]]][string (http://lrm.com/)] bar");

  // Image with title
  MT("imageTitle",
     "[tag ![[foo]]][string (http://lrm.com/ \"bar\")] hello");

  // Image without title
  MT("imageNoTitle",
     "[tag ![[foo]]][string (http://lrm.com/)] bar");
  ...
  MT("labelNoTitle",
     "[link [[foo]]:] [string http://lrm.com/]");

  MT("labelIndented",
     "   [link [[foo]]:] [string http://lrm.com/]");

  MT("labelSpaceTitle",
     "[link [[foo bar]]:] [string http://lrm.com/ \"hello\"]");

  MT("labelDoubleTitle",
     "[link [[foo bar]]:] [string http://lrm.com/ \"hello\"] \"world\"");
  ...
  MT("linkWeb",
     "[link <http://lrm.com/>] foo");

  MT("linkWebDouble",
     "[link <http://lrm.com/>] foo [link <http://lrm.com/>]");

  MT("linkEmail",
     "[link <user@lrm.com>] foo");

  MT("linkEmailDouble",
     "[link <user@lrm.com>] foo [link <user@lrm.com>]");
