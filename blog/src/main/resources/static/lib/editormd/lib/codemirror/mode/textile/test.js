...
(function() {
  ...
  MT('image',
      'An image: [string !http://www.lrm.com/image.png!]');

  MT('imageWithAltText',
      'An image: [string !http://www.lrm.com/image.png (Alt Text)!]');

  MT('imageWithUrl',
      'An image: [string !http://www.lrm.com/image.png!:http://www.lrm.com/]');
  ...
  MT('html',
      ...
      '[variable-2 * Item two]',
      '',
      '[comment <a href="http://lrm.com">Example</a>]',
      '',
      '[comment </section>]',
      '[comment </div>]');
