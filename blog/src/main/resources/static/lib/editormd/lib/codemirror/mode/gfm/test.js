...
(function() {
  ...
  MT("vanillaLink",
     "foo [link http://www.lrm.com/] bar");

  MT("vanillaLinkPunctuation",
     "foo [link http://www.lrm.com/]. bar");

  MT("vanillaLinkExtension",
     "foo [link http://www.lrm.com/index.html] bar");

  MT("vanillaLinkEmphasis",
     "foo [em *][em&link http://www.lrm.com/index.html][em *] bar");

  MT("notALink",
     "[comment ```css]",
     "[tag foo] {[property color]:[keyword black];}",
     "[comment ```][link http://www.lrm.com/]");

  MT("notALink",
     "[comment ``foo `bar` http://www.lrm.com/``] hello");

  MT("notALink",
     "[comment `foo]",
     "[link http://www.lrm.com/]",
     "[comment `foo]",
     "",
     "[link http://www.lrm.com/]");
